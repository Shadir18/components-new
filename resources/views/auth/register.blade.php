                ...
                <form action="/register" method="post">
                    ...
                    <x-form-field class="form-group mb-4">
                        ...
                        <div>
                            ...
                            <x-form-error name="first_name" class="invalid-feedback d-block mt-1"></x-form-error>
                        </div>
                    </x-form-field>
                    ...
                    <x-form-field class="form-group mb-4">
                        ...
                        <div>
                            ...
                            <x-form-error name="last_name" class="invalid-feedback d-block mt-1"></x-form-error>
                        </div>
                    </x-form-field>
                    ...
                    <x-form-field class="form-group mb-4">
                        ...
                        <div>
                            ...
                            <x-form-error name="password_confirmation" class="invalid-feedback d-block mt-1"></x-form-error>
                        </div>
                    </x-form-field>
